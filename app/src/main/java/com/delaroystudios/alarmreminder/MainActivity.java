...
import com.dartElabs.meditationtest.data.AlarmReminderContract;
import com.dartElabs.meditationtest.reminder.AlarmScheduler;
        ...
        switch (item.getItemId()) {
            ...
            case R.id.save_reminder:
                ...
                if (mTitleText.getText().toString().length() == 0){
                    ...
                    Toast.makeText(this, "Reminder Title cannot be blank!", Toast.LENGTH_LONG).show();
                }
